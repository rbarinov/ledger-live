...
// We can remove the eslint disable comment when we move our eslint setup
// to the typescript-eslint project
...
// Add "Navigator" postfix to distinguish from ScreenName
